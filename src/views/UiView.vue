    ...
    <SectionMain>
      <div class="space-y-12">
        ...
        >
          ...
          <template #footer>
            <BaseButtons>
              <BaseButton label="Confirmar" color="info" />
              <BaseButton label="Cancelar" color="info" outline />
            </BaseButtons>
          </template>
        </CardBox>
        ...
        >
          ...
          <template #footer>
            <BaseButtons>
              <BaseButton label="Confirmar" color="danger" />
            </BaseButtons>
          </template>
        </CardBox>
        ...
        >
          ...
          <template #footer>
            <BaseButton label="Confirmar" color="success" />
          </template>
        </CardBox>
      </div>
    </SectionMain>
